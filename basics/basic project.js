...
if(username){
    ...
    console.log('You need to insert a username');
}
/////////////////////////////////
...
if(item == 'jacket'){
    money=money-40;
    health=health+20;
    console.log('You bought a jacket! Equip that hoe')
}
else if(item == 'candy'){
    money = money-10;
    console.log('You bought candy! Eat that hoe!');
}
else if(item =='hammer'){
    money = money-30;
    console.log(' You bought a hammer! Use that hoe!');
}
else if(item == 'paint'){
    money= money-70;
    console.log('You bought paint! Wow that was expensive!');
}
else{
    console.log('You bought nothing. Quit being cheap!');
}
